export function EdgeIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={2500} height={2500} viewBox="-13.151 4.92 291.955 272.123" {...props}>
      <linearGradient
        id="a"
        x1={63.33}
        x2={241.67}
